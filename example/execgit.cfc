<cfcomponent  hint="execgit since there is no cfscript equiv for cfexecute before CF11" output="false">
	<cffunction name="execGit" access="private" output="false" returntype="string">
		...
		<cftry>
			<cfexecute name="#getGitPath()#" arguments="--git-dir=#getRepoPath()#/.git --work-tree=#getRepoPath()# #arguments.gitCommand# #arguments.gitArguments#" timeout="20" variable="local.return" errorvariable="local.error"></cfexecute>
